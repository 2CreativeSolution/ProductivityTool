  ...
  try {
    ...
    switch (type) {
      case 'supply':
        ...
        await sendSupplyRequestNotificationToAdmins(
          mockUser,
          mockRequest,
          mockSupply
        )
      ...
      case 'asset':
        ...
        mockRequest.expectedReturnDate = new Date(
          Date.now() + 30 * 24 * 60 * 60 * 1000
        ) // 30 days from now

        await sendAssetRequestNotificationToAdmins(
          mockUser,
          mockRequest,
          mockAssetCategory
        )
      ...
      default:
        throw new Error(
          'Invalid notification type. Use: supply, asset, or vacation'
        )
    }
