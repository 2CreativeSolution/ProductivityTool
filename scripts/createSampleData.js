  ...
  try {
    ...
    const update = await db.dailyProjectUpdate.create({
      data: {
        ...
        status: 'ON_TRACK',
        description:
          'Completed initial wireframes for the product catalog page. Started working on the user authentication flow design.',
        hoursWorked: 5.5,
        blockers: null,
        nextDayPlan:
          'Continue with authentication flow implementation and review database schema.',
