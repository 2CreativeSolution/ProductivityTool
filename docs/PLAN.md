...
- Assets admin IA is now inventory/assignments-centric: `/assets/management` route/nav removed, create/assign actions moved to header entry points with shared dialog components, assignment action hidden for non-admins on `/assets/assignments`, and employee report detail/list screens standardized on shared table patterns with header-level CSV export. (evidence: web/src/Routes.jsx, web/src/components/AppSidebar/AppSidebar.jsx, web/src/pages/AssetsInventoryPage/AssetsInventoryPage.jsx, web/src/pages/AssetsAssignmentsPage/AssetsAssignmentsPage.jsx, web/src/components/AssetTracker/AssetManagement.jsx, web/src/components/AssetTracker/AssetReports.jsx, web/src/pages/AssetsReportsEmployeeDetailPage/AssetsReportsEmployeeDetailPage.jsx)
