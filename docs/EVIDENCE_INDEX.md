...
| E-057 | .env | Root environment file with required DB, session, SMTP, and seed variables for local dev | .env |
...
| E-101 | web/src/pages/LoginPage/LoginPage.jsx; web/src/pages/SignupPage/SignupPage.jsx; web/src/pages/ForgotPasswordPage/ForgotPasswordPage.jsx; web/src/pages/ResetPasswordPage/ResetPasswordPage.jsx; web/src/styles/brand-nxa.css | Added global auth footer across auth pages | web/src/pages/LoginPage/LoginPage.jsx; web/src/pages/SignupPage/SignupPage.jsx; web/src/pages/ForgotPasswordPage/ForgotPasswordPage.jsx; web/src/pages/ResetPasswordPage/ResetPasswordPage.jsx; web/src/styles/brand-nxa.css |
| E-102 | web/src/components/AuthFooter/AuthFooter.jsx; web/src/pages/LoginPage/LoginPage.jsx; web/src/pages/SignupPage/SignupPage.jsx; web/src/pages/ForgotPasswordPage/ForgotPasswordPage.jsx; web/src/pages/ResetPasswordPage/ResetPasswordPage.jsx | Shared auth footer with dynamic year | web/src/components/AuthFooter/AuthFooter.jsx; web/src/pages/LoginPage/LoginPage.jsx; web/src/pages/SignupPage/SignupPage.jsx; web/src/pages/ForgotPasswordPage/ForgotPasswordPage.jsx; web/src/pages/ResetPasswordPage/ResetPasswordPage.jsx |
| E-103 | web/src/styles/brand-nxa.css; web/src/pages/LoginPage/LoginPage.jsx; web/src/pages/SignupPage/SignupPage.jsx; web/src/pages/ForgotPasswordPage/ForgotPasswordPage.jsx; web/src/pages/ResetPasswordPage/ResetPasswordPage.jsx | Centered auth cards within flex column to push footer to bottom | web/src/styles/brand-nxa.css; web/src/pages/LoginPage/LoginPage.jsx; web/src/pages/SignupPage/SignupPage.jsx; web/src/pages/ForgotPasswordPage/ForgotPasswordPage.jsx; web/src/pages/ResetPasswordPage/ResetPasswordPage.jsx |
| E-104 | web/src/pages/ResetPasswordPage/ResetPasswordPage.jsx | Reset password page uses NXA auth layout | web/src/pages/ResetPasswordPage/ResetPasswordPage.jsx |
| E-105 | web/src/lib/appConfig.js; api/src/lib/appConfig.js; web/src/components/AuthFooter/AuthFooter.jsx | Centralized company link config and footer link | web/src/lib/appConfig.js; api/src/lib/appConfig.js; web/src/components/AuthFooter/AuthFooter.jsx |
...
| E-117 | web/src/components/AppSidebar/AppSidebar.jsx; web/src/components/Header/Header.jsx; web/src/components/Header/Header.test.jsx; web/src/components/Header/Header.stories.jsx; web/src/index.css; web/src/lib/storageKeys.js; web/src/pages/DashboardPage/DashboardPage.jsx; web/src/pages/AssetTrackerPage/AssetTrackerPage.jsx; web/src/pages/ProjectTrackerPage/ProjectTrackerPage.jsx; web/src/pages/AdminPanelPage/AdminPanelPage.jsx; web/src/components/OfficeSupply/SupplyInventory/SupplyInventory.jsx; web/src/components/OfficeSupply/SupplyRequestManager/SupplyRequestManager.jsx; web/src/Routes.jsx | Consolidated sidebar refactor evidence: grouped nav IA, Home anchor behavior, settings/admin restructuring, header removal, shared content shell/background, collapsible compact mode, compact popout submenu access, overflow fixes for clipped dropdowns, and admin route links in Admin submenu with `Overview` first | web/src/components/AppSidebar/AppSidebar.jsx; web/src/components/Header/Header.jsx; web/src/components/Header/Header.test.jsx; web/src/components/Header/Header.stories.jsx; web/src/index.css; web/src/lib/storageKeys.js; web/src/pages/DashboardPage/DashboardPage.jsx; web/src/pages/AssetTrackerPage/AssetTrackerPage.jsx; web/src/pages/ProjectTrackerPage/ProjectTrackerPage.jsx; web/src/pages/AdminPanelPage/AdminPanelPage.jsx; web/src/components/OfficeSupply/SupplyInventory/SupplyInventory.jsx; web/src/components/OfficeSupply/SupplyRequestManager/SupplyRequestManager.jsx; web/src/Routes.jsx |
| E-118 | web/src/Routes.jsx; web/src/pages/User/UsersPage/UsersPage.jsx; web/src/pages/User/NewUserPage/NewUserPage.jsx; web/src/pages/User/UserPage/UserPage.jsx; web/src/pages/User/EditUserPage/EditUserPage.jsx; web/src/pages/OfficeSupply/AdminSupplyRequestsPage/AdminSupplyRequestsPage.jsx; web/src/pages/OfficeSupply/SupplyCategoriesPage/SupplyCategoriesPage.jsx | User/admin management pages moved to shared `AppSidebar` + `app-content-shell` frame and users scaffold wrapping removed | web/src/Routes.jsx; web/src/pages/User/UsersPage/UsersPage.jsx; web/src/pages/User/NewUserPage/NewUserPage.jsx; web/src/pages/User/UserPage/UserPage.jsx; web/src/pages/User/EditUserPage/EditUserPage.jsx; web/src/pages/OfficeSupply/AdminSupplyRequestsPage/AdminSupplyRequestsPage.jsx; web/src/pages/OfficeSupply/SupplyCategoriesPage/SupplyCategoriesPage.jsx |
| E-119 | web/src/Routes.jsx; web/src/components/AppSidebar/AppSidebar.jsx; web/src/pages/User/EditUserPage/EditUserPage.jsx | Admin routes normalized to `/admin*` (`/admin`, `/admin/users*`) with account settings kept available at `/settings/account` | web/src/Routes.jsx; web/src/components/AppSidebar/AppSidebar.jsx; web/src/pages/User/EditUserPage/EditUserPage.jsx |
| E-120 | api/src/lib/smtpConfig.js; api/src/lib/emailService.js | Centralized SMTP config and fixed test email sender to use configured From name/email | api/src/lib/smtpConfig.js; api/src/lib/emailService.js |
